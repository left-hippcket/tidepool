...
export const products = [
  { id: 1, categoryId: 1, categoryName: '누운고기', categoryIcon: '🐟', name: '넙치', orderUnit: '통', unitWeight: 250, originCount: 7, specCount: 35, status: 'active' },
  { id: 2, categoryId: 1, categoryName: '누운고기', categoryIcon: '🐟', name: '강도다리', orderUnit: '통', unitWeight: 250, originCount: 1, specCount: 20, status: 'active' },
  ...
  { id: 6, categoryId: 2, categoryName: '뜬고기', categoryIcon: '🦈', name: '도미', orderUnit: '통', unitWeight: 80, originCount: 2, specCount: 12, status: 'active' },
...
export const specifications = [
  ...
  // 방어 - 일본산/국산 (productId: 4)
  { id: 71, productId: 4, productName: '방어', name: '3.8kg', status: 'active', createdAt: '2024-04-12' },
  { id: 72, productId: 4, productName: '방어', name: '4.5~5.5kg', status: 'active', createdAt: '2024-04-13' },
  { id: 73, productId: 4, productName: '방어', name: '4~5kg', status: 'active', createdAt: '2024-04-14' },
  { id: 74, productId: 4, productName: '방어', name: '4.0kg', status: 'active', createdAt: '2024-04-15' },
  { id: 75, productId: 4, productName: '방어', name: '5.5~6.5kg', status: 'active', createdAt: '2024-04-16' },
  { id: 76, productId: 4, productName: '방어', name: '5.5kg', status: 'active', createdAt: '2024-04-17' },
  { id: 77, productId: 4, productName: '방어', name: '5.7kg', status: 'active', createdAt: '2024-04-18' },
  { id: 78, productId: 4, productName: '방어', name: '5.8kg', status: 'active', createdAt: '2024-04-19' },
  { id: 79, productId: 4, productName: '방어', name: '5~5.5kg', status: 'active', createdAt: '2024-04-20' },
  { id: 80, productId: 4, productName: '방어', name: '5~6kg', status: 'active', createdAt: '2024-04-21' },
  { id: 81, productId: 4, productName: '방어', name: '5.0kg', status: 'active', createdAt: '2024-04-22' },
  { id: 82, productId: 4, productName: '방어', name: '6.2kg', status: 'active', createdAt: '2024-04-23' },
  { id: 83, productId: 4, productName: '방어', name: '6.4kg', status: 'active', createdAt: '2024-04-24' },
  { id: 84, productId: 4, productName: '방어', name: '6.5kg', status: 'active', createdAt: '2024-04-25' },
  { id: 85, productId: 4, productName: '방어', name: '6.8kg', status: 'active', createdAt: '2024-04-26' },
  { id: 86, productId: 4, productName: '방어', name: '6~7kg', status: 'active', createdAt: '2024-04-27' },
  { id: 87, productId: 4, productName: '방어', name: '6.0kg', status: 'active', createdAt: '2024-04-28' },
  { id: 88, productId: 4, productName: '방어', name: '7~8kg', status: 'active', createdAt: '2024-04-29' },
  { id: 89, productId: 4, productName: '방어', name: '7.0kg', status: 'active', createdAt: '2024-04-30' },
  { id: 90, productId: 4, productName: '방어', name: '8~10kg', status: 'active', createdAt: '2024-05-01' },
  { id: 91, productId: 4, productName: '방어', name: '8~9kg', status: 'active', createdAt: '2024-05-02' },
  { id: 92, productId: 4, productName: '방어', name: '8.0kg', status: 'active', createdAt: '2024-05-03' },
  { id: 93, productId: 4, productName: '방어', name: '9~10kg', status: 'active', createdAt: '2024-05-04' },
  { id: 94, productId: 4, productName: '방어', name: '9.0kg', status: 'active', createdAt: '2024-05-05' },
  ...
  { id: 101, productId: 6, productName: '도미', name: '1.5~1.7kg', status: 'active', createdAt: '2024-05-12' },
  { id: 102, productId: 6, productName: '도미', name: '1.5~2kg', status: 'active', createdAt: '2024-05-13' },
  { id: 103, productId: 6, productName: '도미', name: '1.5kg', status: 'active', createdAt: '2024-05-14' },
  ...
  { id: 108, productId: 6, productName: '도미', name: '2~2.5kg', status: 'active', createdAt: '2024-05-19' },
  { id: 109, productId: 6, productName: '도미', name: '2.3kg', status: 'active', createdAt: '2024-05-20' },
  { id: 110, productId: 6, productName: '도미', name: '2.5kg', status: 'active', createdAt: '2024-05-21' },
  { id: 111, productId: 6, productName: '도미', name: '2kg', status: 'active', createdAt: '2024-05-22' },
